...
TRAINING_DATASET_FILE_PATH = r'/users/sgreen/LearningMatch/LVK/Paper/MassParameters/TrainingDataset1000/1000MassTrainingDataset.csv'
VALIDATION_DATASET_FILE_PATH = r'/users/sgreen/LearningMatch/LVK/Paper/MassParameters/TrainingDataset1000/100MassValidationDataset.csv'

#Define ouput location of the Standard.Scaler()
STANDARD_SCALER = '/users/sgreen/LearningMatch/LVK/Paper/MassParameters/TrainingDataset1000/StandardScaler.bin'
...
LOSS = '/users/sgreen/LearningMatch/LVK/Paper/MassParameters/TrainingDataset1000/TrainingValidationLoss.csv'
