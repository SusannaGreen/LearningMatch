...
TRAINING_DATASET_FILE_PATH = r'/users/sgreen/LearningMatch/LVK/Paper/MassParameters/TrainingDataset10000/10000MassTrainingDataset.csv'
VALIDATION_DATASET_FILE_PATH = r'/users/sgreen/LearningMatch/LVK/Paper/MassParameters/TrainingDataset10000/1000MassValidationDataset.csv'

#Define ouput location of the Standard.Scaler()
STANDARD_SCALER = '/users/sgreen/LearningMatch/LVK/Paper/MassParameters/TrainingDataset10000/StandardScaler.bin'
...
LOSS = '/users/sgreen/LearningMatch/LVK/Paper/MassParameters/TrainingDataset10000/TrainingValidationLoss.csv'
