...
TRAINING_DATASET_FILE_PATH = DATA_DIR+r'10000MassTrainingDataset.csv'
VALIDATION_DATASET_FILE_PATH = DATA_DIR+r'1000MassValidationDataset.csv'
...
LOSS = DATA_DIR+'10000TrainingValidationLoss.csv'
