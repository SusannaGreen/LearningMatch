...
TRAINING_DATASET_FILE_PATH = DATA_DIR+r'2000000LambdaEtaSpinTrainingDataset.csv'
VALIDATION_DATASET_FILE_PATH = DATA_DIR+r'200000LambdaEtaSpinValidationDataset.csv'

#Define ouput location of the Standard.Scaler()
STANDARD_SCALER = DATA_DIR+'2000000LambdaEtatandardScaler.bin'

#Define output location of the LearningMatch model
LEARNINGMATCH_MODEL = DATA_DIR+'2000000LambdaEtaLearningMatchModel.pth'

#Define output location for the training and validation loss
LOSS = DATA_DIR+'2000000LambdaEtaTrainingValidationLoss.csv'
...
TrainingBank[['ref_lambda0', 'ref_eta', 'lambda0', 'eta']] = scaler.fit_transform(TrainingBank[['ref_lambda0', 'ref_eta', 'lambda0', 'eta']])
ValidationBank[['ref_lambda0', 'ref_eta', 'lambda0', 'eta']] = scaler.transform(ValidationBank[['ref_lambda0', 'ref_eta', 'lambda0', 'eta']])
