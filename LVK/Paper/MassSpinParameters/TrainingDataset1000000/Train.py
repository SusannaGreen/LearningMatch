...
TRAINING_DATASET_FILE_PATH = r'/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset1000000/1000000MassSpinTrainingDataset.csv'
VALIDATION_DATASET_FILE_PATH = r'/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset1000000/100000MassSpinValidationDataset.csv'

#Define ouput location of the Standard.Scaler()
STANDARD_SCALER = '/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset1000000/std_scaler.bin'
...
LOSS = '/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset1000000/TrainingValidationLoss.csv'
