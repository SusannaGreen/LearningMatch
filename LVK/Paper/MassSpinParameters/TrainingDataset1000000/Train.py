...
logger.info(f'IMPORTANT: The mean of the standard scaler is {scaler_mean}')
logger.info(f'IMPORTANT: The standard deviation of the standard scaler is {scaler_std}')
