...
TEST_DATASET_FILE_PATH = DATA_DIR+r'10000MchirpEtaSpinTestDataset.csv'

#Define location of the scaling
SCALER_FILE_PATH = DATA_DIR+'2000000MchirpEtatandardScaler.bin'
...
LOSS_FILE = DATA_DIR+ r'2000000MchirpEtaTrainingValidationLoss.csv'

#Defining the location of the outputs
LOSS_CURVE = DATA_DIR+'MchirpEtaSpinLossCurve.png'
ERROR_HISTOGRAM = DATA_DIR+'MchirpEtaSpinError.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'MchirpEtaSpinActualPredicted.png'
...
test_dataset[['ref_mchirp', 'ref_eta', 'mchirp', 'eta']] = scaler.transform(test_dataset[['ref_mchirp', 'ref_eta', 'mchirp', 'eta']])

#Convert to a Tensor
logger.info("Converting the test dataset into a tensor")
x_test = np.vstack((test_dataset.ref_mchirp.values, test_dataset.ref_eta.values,
                    test_dataset.ref_spin1.values, test_dataset.ref_spin2.values, 
                    test_dataset.mchirp.values, test_dataset.eta.values,
