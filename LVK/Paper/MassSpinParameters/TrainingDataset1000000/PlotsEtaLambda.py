...
TEST_DATASET_FILE_PATH = DATA_DIR+r'10000LambdaEtaSpinTestDataset.csv'

#Define location of the scaling
SCALER_FILE_PATH = DATA_DIR+'2000000LambdaEtatandardScaler.bin'
...
LOSS_FILE = DATA_DIR+ r'2000000LambdaEtaTrainingValidationLoss.csv'

#Defining the location of the outputs
LOSS_CURVE = DATA_DIR+'EtaLambdaSpinLossCurve.png'
ERROR_HISTOGRAM = DATA_DIR+'EtaLambdaSpinError.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'EtaLambdaSpinActualPredicted.png'
...
test_dataset[['ref_lambda0', 'ref_eta', 'lambda0', 'eta']] = scaler.transform(test_dataset[['ref_lambda0', 'ref_eta', 'lambda0', 'eta']])
