...
LOSS_CURVE = DATA_DIR+'100000MassSpinLossCurve.png'
ERROR_HISTOGRAM = DATA_DIR+'100000MassSpinError.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'100000MassSpinActualPredicted.png'
