...
TEST_DATASET_FILE_PATH = r'/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset100000/5000MassSpinTestDataset.csv'

#Define location of the scaling
SCALER_FILE_PATH = '/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset100000/std_scaler.bin'

#Define location of the trained LearningMatch model 
LEARNINGMATCH_MODEL = '/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset100000/LearningMatchModel.pth'

#Define location of the loss File
LOSS_FILE = r'/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset100000/TrainingValidationLoss.csv'

#Defining the location of the outputs
LOSS_CURVE = '/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset100000/LossCurve.pdf'
ERROR_HISTOGRAM = '/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset100000/Error.pdf'
ACTUAL_PREDICTED_PLOT = '/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/TrainingDataset100000/ActualPredicted.pdf'
