...
LOSS_CURVE = DATA_DIR+'100000MassSpinLossCurve.pdf'
ERROR_HISTOGRAM = DATA_DIR+'100000MassSpinError.pdf'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'100000MassSpinActualPredicted.pdf'
