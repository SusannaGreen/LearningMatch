...
TRAINING_DATASET_FILE_PATH = DATA_DIR+r'LimitedGeoUnsorted1200000MassSpinTemplateBank.csv'
VALIDATION_DATASET_FILE_PATH = DATA_DIR+r'100000MassSpinValidationDatasetBeta.csv'
TEST_DATASET_FILE_PATH = DATA_DIR+r'5000MassSpinTestDatasetBeta.csv'

#Defining the location of the outputs
LOSS_CURVE = DATA_DIR+'1000000MassSpinLossCurveGeo.png'
ERROR_HISTOGRAM = DATA_DIR+'1000000MassSpinErrorGeo.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'1000000MassSpinActualPredictedGeo.png'

#Define output location of the LearningMatch model
LEARNINGMATCH_MODEL = DATA_DIR+'LearningMatchModelGeo.pth'
...
#scheduler = CyclicPlateau(optimizer, 'min') Show learning curve
