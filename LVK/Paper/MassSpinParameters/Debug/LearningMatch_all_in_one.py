...
LOSS_CURVE = DATA_DIR+'1000000MassSpinLossCurveLessEpochs2.png'
ERROR_HISTOGRAM = DATA_DIR+'1000000MassSpinErrorLessEpochs2.png'
...
LEARNINGMATCH_MODEL = DATA_DIR+'LearningMatchModelLessEpochs.pth'
