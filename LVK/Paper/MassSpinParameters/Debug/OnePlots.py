...
TEST_DATASET_FILE_PATH = DATA_DIR+r'SmallMassOneMillionMatchDataset.csv'
...
LEARNINGMATCH_MODEL =  DATA_DIR+'300000LearningMatchModelExtreme.pth'

#Defining the location of the outputs
ERROR_HISTOGRAM = DATA_DIR+'SmallMassOneMillionMassSpinError.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'SmallMassOneMillionMassSpinActualPredicted.png'
