...
LOSS_CURVE = DATA_DIR+'1000000MassSpinLossCurveBeta4.png'
ERROR_HISTOGRAM = DATA_DIR+'1000000MassSpinErrorBeta4.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'1000000MassSpinActualPredictedBeta4.png'

#Define output location of the LearningMatch model
LEARNINGMATCH_MODEL = DATA_DIR+'LearningMatchModelBeta4.pth'
