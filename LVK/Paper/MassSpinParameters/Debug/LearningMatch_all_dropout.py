...
from ModelDropout import NeuralNetwork
...
LOSS_CURVE = DATA_DIR+'1000000MassSpinLossCurveDropout2.png'
ERROR_HISTOGRAM = DATA_DIR+'1000000MassSpinErrorDropout2.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'1000000MassSpinActualPredictedDropout2.png'

#Define output location of the LearningMatch model
LEARNINGMATCH_MODEL = DATA_DIR+'LearningMatchModelDropout.pth'
