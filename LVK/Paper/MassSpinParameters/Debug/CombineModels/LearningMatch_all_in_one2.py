...
DATA_DIR = '/users/sgreen/LearningMatch/LVK/Paper/MassSpinParameters/Debug/CombineModels/'

#Define location to the training and validation dataset
TRAINING_DATASET_FILE_PATH = DATA_DIR+r'2000000MassSpinTrainingDataset.csv'
VALIDATION_DATASET_FILE_PATH = DATA_DIR+r'200000MassSpinValidationDataset.csv'
TEST_DATASET_FILE_PATH = DATA_DIR+r'5000MassSpinTestDataset.csv'

#Defining the location of the outputs
LOSS_CURVE = DATA_DIR+'MassSpinLossCurve_21.png'
ERROR_HISTOGRAM = DATA_DIR+'MassSpinError_21.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'MassSpinActualPredicted_21.png'

#Define output location of the LearningMatch model
LEARNINGMATCH_MODEL = DATA_DIR+'LearningMatchModel_21.pth'
