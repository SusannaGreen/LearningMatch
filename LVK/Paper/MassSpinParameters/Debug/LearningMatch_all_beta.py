...
TRAINING_DATASET_FILE_PATH = DATA_DIR+r'1000000MassSpinTrainingDatasetBeta.csv'
...
LOSS_CURVE = DATA_DIR+'1000000MassSpinLossCurveBeta3.png'
ERROR_HISTOGRAM = DATA_DIR+'1000000MassSpinErrorBeta3.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'1000000MassSpinActualPredictedBeta3.png'

#Define output location of the LearningMatch model
LEARNINGMATCH_MODEL = DATA_DIR+'LearningMatchModelBeta3.pth'
