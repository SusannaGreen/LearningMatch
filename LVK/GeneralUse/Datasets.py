...
TRAINING_DATASET_FILE = '/users/sgreen/LearningMatch/LVK/GeneralUse/MassSpinTrainingBank2.csv'
VALIDATION_DATASET_FILE = '/users/sgreen/LearningMatch/LVK/GeneralUse/MassSpinValidationBank2.csv'
TEST_DATASET_FILE = '/users/sgreen/LearningMatch/LVK/GeneralUse/MassSpinTestBank2.csv'
