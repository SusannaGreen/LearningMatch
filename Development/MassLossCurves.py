...
plt.semilogy(np.arange(1, len(loss_array)+1), loss_array, color='#5B2C6F', label='1000 Training Loss')
plt.semilogy(np.arange(1, len(val_loss_array)+1), val_loss_array, color='#0096FF', label='1000 Validation Loss')
