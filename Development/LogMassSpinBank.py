...
#Training dataset
mass = np.random.uniform(np.log10(3.0), np.log10(100), size=(SIZE, 2))
reference_mass = np.random.uniform(np.log10(3.0), np.log10(100), size=(SIZE, 2))
...
MassSpinMatchDataset.to_csv('1000000LogMassSpinMatchDataset.csv', index = False)

print("The size of the dataset", SIZE)
print("This generated a dataset called: 1000000LogMassSpinMatchDataset")
