...
DATA_DIR = '/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers6/'

#Define location of the test dataset
TEST_DATASET_FILE_PATH = '/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers6/100000LambdaEtaAlignedSpinTestDataset+150000DiffusedLambdaEtaAlignedSpinTestDataset.csv'
