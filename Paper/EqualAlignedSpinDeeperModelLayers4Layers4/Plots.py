...
DATA_DIR = '/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers4/'

#Define location of the test dataset
TEST_DATASET_FILE_PATH = '/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers4/100000LambdaEtaAlignedSpinTestDataset+150000DiffusedLambdaEtaAlignedSpinTestDataset.csv'
