...
DATA_DIR = '/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers2/'

#Define location of the test dataset
TEST_DATASET_FILE_PATH = '/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers2/100000LambdaEtaAlignedSpinTestDataset+150000DiffusedLambdaEtaAlignedSpinTestDataset.csv'
