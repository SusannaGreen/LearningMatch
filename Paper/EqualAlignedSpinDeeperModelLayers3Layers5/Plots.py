...
DATA_DIR = '/users/sgreen/LearningMatch/Paper/LambdaEtaEqualSpin/'

#Define location of the test dataset
TEST_DATASET_FILE_PATH = '/users/sgreen/LearningMatch/Paper/LambdaEtaEqualSpin/100000LambdaEtaAlignedSpinTestDataset+150000DiffusedLambdaEtaAlignedSpinTestDataset.csv'
