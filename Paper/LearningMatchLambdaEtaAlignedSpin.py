...
file_handler = logging.FileHandler('LambdaEtaAlignedSpin.log') # define file handler and set formatter
...
LEARNINGMATCH_MODEL = DATA_DIR+'LearningMatchModelLambdaEtaAlignedSpinLR6Batch1024.pth'

#Defining the location of the outputs
LOSS_CURVE = DATA_DIR+'LossCurveLambdaEtaAlignedSpinLR6Batch1024.png'
ERROR_HISTOGRAM = DATA_DIR+'ErrorLambdaEtaAlignedSpinLR6Batch1024.png'
ACTUAL_PREDICTED_PLOT = DATA_DIR+'ActualPredictLambdaEtaAlignedSpinLR6Batch1024.png'
