...
#TRAINING_VALIDATION_LOSS_1 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers1/TrainingValidationLoss.csv'
TRAINING_VALIDATION_LOSS_2 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers2/TrainingValidationLoss.csv'
TRAINING_VALIDATION_LOSS_3 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers3/TrainingValidationLoss.csv'
TRAINING_VALIDATION_LOSS_4 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers4/TrainingValidationLoss.csv'
TRAINING_VALIDATION_LOSS_5 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers5/TrainingValidationLoss.csv'
TRAINING_VALIDATION_LOSS_6 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinDeeperModelLayers4Layers6/TrainingValidationLoss.csv'
...
#training_loss_1 = training_validation_loss_1.training_loss.values[100:]
...
#plt.semilogy(np.arange(1, len(training_loss_1)+1), training_loss_1, color='#a74b9c', label='1 crunch layers')
#plt.semilogy(np.arange(1, len(validation_loss_1)+1), validation_loss_1, color='#0096FF', label='1 Layers Validation Loss')
plt.semilogy(np.arange(1, len(training_loss_2)+1), training_loss_2, color='#8855fc', label='2 crunch layers')
#plt.semilogy(np.arange(1, len(validation_loss_2)+1), validation_loss_2, color='#0096FF', label='2 Layers Validation Loss')
plt.semilogy(np.arange(1, len(training_loss_3)+1), training_loss_3, color='#1c9df8', label='3 crunch layers')
#plt.semilogy(np.arange(1, len(validation_loss_3)+1), validation_loss_3, color='#0096FF', label='3 Layers Validation Loss')
plt.semilogy(np.arange(1, len(training_loss_4)+1), training_loss_4, color='#5B2C6F', label='4 crunch layers')
#plt.semilogy(np.arange(1, len(validation_loss_4)+1), validation_loss_3, color='#0096FF', label='4 Layers Validation Loss')
plt.semilogy(np.arange(1, len(training_loss_5)+1), training_loss_5, color='#b00068', label='5 crunch layers')
#plt.semilogy(np.arange(1, len(validation_loss_5)+1), validation_loss_5, color='#0096FF', label='5 Layers Validation Loss')
plt.semilogy(np.arange(1, len(training_loss_6)+1), training_loss_6, color='#fd3db5', label='6 crunch layers')
#plt.semilogy(np.arange(1, len(validation_loss_6)+1), validation_loss_6, color='#0096FF', label='6 Layers Validation Loss')
plt.xlabel('Epochs')
plt.ylabel('Loss')
