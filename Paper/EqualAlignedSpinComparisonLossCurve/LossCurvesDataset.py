...
TRAINING_VALIDATION_LOSS_1 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinTrainingDataset25000/TrainingValidationLoss.csv'
TRAINING_VALIDATION_LOSS_2 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinTrainingDataset250000/TrainingValidationLoss.csv'
TRAINING_VALIDATION_LOSS_3 = r'/users/sgreen/LearningMatch/Paper/EqualAlignedSpinTrainingDataset2500000/TrainingValidationLoss.csv'
...
#plt.semilogy(np.arange(1, len(validation_loss_1)+1), validation_loss_1, color='#0096FF', label='25000 Validation Loss')
plt.semilogy(np.arange(1, len(training_loss_2)+1), training_loss_2, color='#8855fc', label='250000 training dataset')
#plt.semilogy(np.arange(1, len(validation_loss_2)+1), validation_loss_2, color='#0096FF', label='250000 Validation Loss')
plt.semilogy(np.arange(1, len(training_loss_3)+1), training_loss_3, color='#1c9df8', label='2500000 training dataset')
#plt.semilogy(np.arange(1, len(validation_loss_3)+1), validation_loss_3, color='#0096FF', label='2500000 Validation Loss')
plt.xlabel('Epochs')
plt.ylabel('Loss')
