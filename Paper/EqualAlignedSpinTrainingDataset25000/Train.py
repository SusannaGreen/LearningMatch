...
DATA_DIR = '/users/sgreen/LearningMatch/Paper/EqualAlignedSpinTrainingDataset25000/'

#Define location to the training and validation dataset
TRAINING_DATASET_FILE_PATH = DATA_DIR+r'10000LambdaEtaAlignedSpinTrainingDataset+15000DiffusedLambdaEtaAlignedSpinTrainingDataset.csv'
VALIDATION_DATASET_FILE_PATH = DATA_DIR+r'1000LambdaEtaAlignedSpinValidationDataset+1500DiffusedLambdaEtaAlignedSpinValidationDataset.csv'
